...
public class ChronoGUI extends JFrame {
	...
	public ChronoGUI(chronotimer timer) {
        ...
        //---------------JTextArea
	        ...
	        JTextArea printerArea = new JTextArea();
...
//	        Interface.add(lblFinish);
       ...
       //--------------JButtons
	        ...
	        btnPrint.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(t.getRun() != null){
						String toParse = t.print();
					
					printerArea.setText(printerArea.getText().concat(toParse + '\n'));
					}
				};
	        ...
	        btnNumpad12.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(t.powerState() && !numPad.getText().isEmpty() && numPad.getText().matches(("[0-9]+") ) && t.getRun() != null){
						...
						mainArea.setText(mainArea.getText().concat("added " + numPad.getText() + '\n'));
						//clear numPad
					}
					numPad.setText("");
				}
	        ...
	        btnNewRun.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		if(t.powerState()){
	        			 if(t.getRun() == null){
			        		t.createRun();
							mainArea.setText(mainArea.getText().concat("creating a new run" + '\n'));
	        			 }else
	         				mainArea.setText(mainArea.getText().concat("run already exists. end it first" + '\n'));
	        		}
	        ...
	        btnEndRun.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		if(t.powerState()){
	       			 if(t.getRun() != null){
			        		t.endRun();
							mainArea.setText(mainArea.getText().concat("ending current run" + '\n'));
	       			 }else
	        				mainArea.setText(mainArea.getText().concat("no run to end. create one" + '\n'));
	        		}
	        	}
	        });
        ...
        rdbtnIND.setBounds(42, 310, 127, 25);
        ...
        rdbtnIND.addItemListener(new ItemListener(){
			...
			public void itemStateChanged(ItemEvent e) {
				...
				mainArea.setText(mainArea.getText().concat("Event Type: IND" + '\n'));
				t.setEvent("IND");
			}
        ...
        rdbtnPAIRIND.setBounds(42, 340, 127, 25);
        ...
        rdbtnPAIRIND.addItemListener(new ItemListener(){
			...
			public void itemStateChanged(ItemEvent e) {
				// TODO Auto-generated method stub
				if(e.getStateChange() == ItemEvent.SELECTED && t.powerState())
				mainArea.setText(mainArea.getText().concat("Event Type: PARAIND" + '\n'));
				t.setEvent("PARAIND");
			}
        ...
        rdbtnGROUP.setBounds(42, 370, 127, 25);
        ...
        rdbtnGROUP.addItemListener(new ItemListener(){
			...
			public void itemStateChanged(ItemEvent e) {
				// TODO Auto-generated method stub
				if(e.getStateChange() == ItemEvent.SELECTED && t.powerState())
				mainArea.setText(mainArea.getText().concat("Event Type: GROUP" + '\n'));
				t.setEvent("GRP");
			...
			public void actionPerformed(ActionEvent e) {
				...
				case "Gate":
					if(!t.ch[channelNum].hasSensor()) 
						...
						mainArea.setText(mainArea.getText().concat("Channel " + channelNum + " already has a sensor !" + '\n'));
					...
					channelNum = Integer.parseInt(chSelect.getSelection().getActionCommand());
						...
						case "Gate": 
							if(t.ch[channelNum].hasSensor()) 
								...
								mainArea.setText(mainArea.getText().concat("no sensor attached !" + '\n'));
							break;
						case "Eye":
							if(t.ch[channelNum].hasSensor()) 
								t.ch[channelNum].disconnectSensor();
	...
	private class powerListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(!t.powerState()){
				t.turnOn();
				mainArea.setText(mainArea.getText().concat("Initializing... Ready ! " + '\n'
				));
			}
			else{
				t.turnOff();
				mainArea.setText(mainArea.getText().concat("Good-Bye... ! " + '\n'));
				}
		}
	}
	...
	private class channelTrigger implements ActionListener
	{
		@Override
		public void actionPerformed(ActionEvent e) {
